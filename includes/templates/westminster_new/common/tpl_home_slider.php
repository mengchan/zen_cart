<div class="content-slider">
   ...
   $banner = $db->Execute("SELECT banners_id, banners_title, banners_image, banners_html_text, banners_sort_order, banners_open_new_windows, banners_url FROM " . TABLE_BANNERS . " WHERE status = 1 AND banners_group = 'homepageslide1' order by banners_sort_order");
