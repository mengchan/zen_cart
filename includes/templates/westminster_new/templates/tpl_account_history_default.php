 ...
 * Modified by Anne (Picaflor-Azul.com) Westiminster New v1.0
 */
?>
...
<br class="clearBoth" />
    ...
    <div class="content"><?php echo '<strong><span class="content-right">' . TEXT_ORDER_PRODUCTS . '</span></strong> ' . $history['product_count'] . '<br /><strong><span class="content-right">' . TEXT_ORDER_COST . '</span></strong> ' . strip_tags($history['order_total']); ?></div>
